...
const styles = StyleSheet.create({
  ...
  covermain:{alignItems:"center",flexDirection:"row", backgroundColor:Colors.white, height:55, paddingHorizontal:20, borderRadius:8, marginHorizontal:3,marginBottom:6,},
