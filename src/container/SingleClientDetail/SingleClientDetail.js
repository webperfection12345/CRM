    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.PrimaryColor }}>
      <View style={{ flex: 1, backgroundColor: Colors.white }}>
        ...
        <View style={{ flex: 1, marginTop:15 }}>
         <ScrollView style={{ flex: 1, paddingHorizontal:12,backgroundColor:Colors.white }}>
...
<Image
  ...
  <View>
    <Text style={styles.switchermain}> <Switch
...
<Text style={styles.boldphoneadd}> Main Address: </Text>
  <Text style={styles.phonenumberadd}>302 Delaware Rd. Smallville, KS 58123 302 Delaware Rd. Smallville, KS 58123

  </Text>
</View>
<View style={styles.mainareacover}>
  <Text
                style={styles.boldphone}
              >
                Note
              </Text>
<View
...
<Image
  ...
  <View style={styles.mainheadingid}>
    ...
    <Text style={styles.idinnerbold}>047 Jefferson Street City Kettlersville 047 Jeffe St. City Kettlersville</Text>
    </View>
...
<Image
          ...
          <Image
            ...
            <Text style={styles.activityheading}>Drip Campaign Initiated</Text>
            <TouchableOpacity 
            style={styles.iconcoverlatest}
          > 
          <Image
...
const styles = StyleSheet.create({
  ...
  dispos:{marginTop:5,flexDirection:"row",alignItems:"center",justifyContent:"flex-start",marginBottom:8},
  activityheading:{fontSize:13},
  activitycol:{flexDirection:"row",alignItems:"center",width:"43%"},
  activitycolnew:{flexDirection:"row",alignItems:"center",justifyContent:"flex-start",width:"53%"},
  transactionheading:{fontSize:20,fontWeight:"bold"},
  transactionmain:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",
marginTop:25},
transactionmaindis:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",
marginTop:25,marginBottom:20},
  phonenumber:{paddingVertical:7,fontSize:14},
  phonenumberadd:{paddingVertical:7,fontSize:14,flexDirection:"column",paddingHorizontal:5,paddingTop:2},
  boldphone:{fontWeight:"bold",fontSize:14,},

  pendingdetail:{flexDirection:"row",textAlign:"left",justifyContent:"flex-start",marginBottom:4},
  threeiconmain:{
    flexDirection:"row",
    alignItems:"center"
  },
boldphoneadd:{fontWeight:"bold",fontSize:14,width:"100%",flexDirection:"column",alignItems:"center"},
  maincoverop: { marginTop: 40, marginBottom: 40,
  alignItems:"center" },
  maincoverid:{borderBottomColor:Colors.cream,
  borderBottomWidth:1,
  marginVertical:12,

},
  idheading:{fontWeight:"bold",fontSize:15,
marginBottom:7},
...
onlinedot:{height:15,width:15,backgroundColor:"#08d007",borderRadius:100,left:-1,top:10,
position:"absolute"},
imagewithdot:{position:"relative",},
clientinformation:{flexDirection:"column",
alignItems:"center"},
speedcover:{
width:"20%"
},

idinnerbold:{fontSize:14,
lineHeight:22},
clientinformationinner:{paddingVertical:12,
textAlign:"center",
alignItems:"center",
paddingBottom:7
},
mainareacover:{marginHorizontal:7},
iconcover:{  flexDirection: "row",
justifyContent: "center",
alignItems: "center",
marginHorizontal:2,
backgroundColor:Colors.PrimaryColor,
...
texton:{position:"absolute",color:Colors.white,fontSize:12,marginLeft:7,marginTop:5},
});
